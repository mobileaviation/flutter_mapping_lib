class Airac {
  ...
  static String _getAiracCycle(DateTime dateTime) {
    ...
    num cyclesUntilStartThisYear = (new DateTime(dateTime.year).difference(_epoch).inDays / 28).floor();
    ...
    cyclesThisYearS = (cyclesThisYearS.length==1) ? cyclesThisYearS.padLeft(2, "0") : cyclesThisYearS;
